      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            ...
            {/* 1. Copani LLC (Details on Left / Logo on Right) - FIXED STRUCTURE */}
            <div className="relative flex flex-col md:flex-row items-center">
              
              {/* Content Box (Left Side) */}
              <div className="w-full md:w-1/2 md:order-1 md:pr-10">
              ...
              {/* Logo (Right Side) */}
              <div className="w-full md:w-1/2 md:order-3 flex justify-start md:pl-10 mt-4 md:mt-0">
                <img
            ...
            {/* 2. Reliance Jio (Details on Right / Logo on Left) - ORIGINAL CODE (works as intended) */}
            <div className="relative flex flex-col md:flex-row items-center">
              {/* Logo (Left Side) - Adjusted to use Flexbox ordering */}
              <div className="w-full md:w-1/2 md:order-1 flex justify-start md:justify-end md:pr-10 mb-4 md:mb-0">
                <img
              ...
              {/* Timeline Dot (Middle) - Corrected to be absolute within the relative parent */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 bg-indigo-600 dark:bg-indigo-400 rounded-full w-6 h-6 border-4 border-white dark:border-gray-900"></div>

              {/* Content Box (Right Side) */}
              <div className="w-full md:w-1/2 md:order-3 md:pl-10">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-colors duration-300">
            ...
            {/* 3. High Radius (Details on Left / Logo on Right) - FIXED STRUCTURE */}
            <div className="relative flex flex-col md:flex-row items-center">
